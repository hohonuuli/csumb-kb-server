  ...
  get("/getMetadata/:name", (request, response) -> {
    ...
    get("/getLinkRealizations", (request, response) -> {
      ...
      try {
        ...
        String linkRealizationResponse = linkRealizationUtil.getLinkRealizations(toolBelt, request.queryParams("concept"));
    ...
    post("/addLinkRealizations", (request, response) -> {
      ...
      try {
        ...
        if (linkRealizationUtil.addLinkRealizations(toolBelt, request.queryParams("concept"), request.queryParams("linkName"), request.queryParams("toConcept"))) {
